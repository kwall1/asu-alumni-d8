...
class SmartIpEventSubscriber extends SmartIpEventSubscriberBase {
  ...
  public function formSettings(AdminSettingsEvent $event) {
    ...
    $form['device_geolocation_preferences']['device_geolocation_google_map_language'] = [
      ...
      '#description' => t(
        'See @google_localization', [
          '@google_localization' => Link::fromTextAndUrl(t('Google Maps API - Localizing the Map'), Url::fromUri('https://developers.google.com/maps/documentation/javascript/localization'))->toString(),
        ]),
    ];
    $event->setForm($form);
  }
