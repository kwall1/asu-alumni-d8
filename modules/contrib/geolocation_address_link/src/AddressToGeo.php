...
class AddressToGeo {
  ...
  public function setFormatter() {
    $this->formatter = new PostalLabelFormatter($this->addressFormatRepository, $this->countryRepository, $this->subdivisionRepository, $this->formatCountry, $this->formatLanguage);
  }
